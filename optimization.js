...
function preloadCriticalResources() {
  const resources = [
    ...
    { href: 'https://www.gstatic.com/firebasejs/9.6.0/firebase-app-compat.js', as: 'script' },
    { href: 'https://www.gstatic.com/firebasejs/9.6.0/firebase-firestore-compat.js', as: 'script' }
  ];
